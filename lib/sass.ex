defmodule Sass do
  @moduledoc """
    ...
    * include_paths list of directorys for Sass to search for imports ex. `["bower_compoents", "../node_modules"]`
  """
  ...
  @doc """
    ...
    ## Examples
        ...
        iex> Sass.compile("$white : #fff; a { color: $white;}")
        "a { color: #fff; }"

        iex> Sass.compile("$white : #fff; a { color: $white;}", %{output_style: Sass.sass_style_compressed})
        "a{color:#fff;}"
  """
  ...
  @doc """
    ...
    iex> Greeter.compile_file("application.scss")
        "a { color: #fff; }"

    iex> Sass.compile_file("application.scss", %{output_style: Sass.sass_style_compressed})
        "a{color:#fff;}"
